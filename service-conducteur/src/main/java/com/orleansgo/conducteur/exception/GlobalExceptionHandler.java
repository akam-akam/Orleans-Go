...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleConducteurNotFoundException(
            ConducteurNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handleVehiculeNotFoundException(
